...
CREATE TABLE `user_history` (
  ...
  `episodes_remaining` int(10) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_history` (`user_id`, `m_id`, `e_id`, `watch_date`, `personal_rating`, `episodes_remaining`) VALUES
...
ALTER TABLE `user_history`
  ADD PRIMARY KEY (`m_id`,`user_id`,`e_id`);
